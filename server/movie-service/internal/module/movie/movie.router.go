...
func (h Handler) RegisterRoutes(router *mux.Router) {
	...
	_movieRouter := router.PathPrefix("/movie/g").Subrouter()
	_movieRouter.HandleFunc("/t/gost", h.MovieTextFREEHandler).Methods(http.MethodPost)
	_movieRouter.HandleFunc("/image/{image}", h.MovieImageHandler).Methods(http.MethodGet)
}
